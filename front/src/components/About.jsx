    ...
    <div className={`about-section ${visible ? 'fade-in' : 'hidden'}`} ref={containerRef}>
      ...
      <div className="about-content section-container">
        <div className="about-image-container">
          <img src="/me3.png" className="about-image" />
        ...
        <div className="about-text">
          ...
          <p>
            ...
            I enjoy designing beautiful, user-friendly experiences that blend functionality with personality.
          </p>
          <p>
            I’ve gained strong skills in <strong>front-end and back-end</strong> development, problem solving,
            and UI/UX design — and I’m always excited to learn something new and challenge myself!
          </p>

          <div className="about-skills">
            <div className="skill-item"><FaLaptopCode /> MERN Developer</div>
            <div className="skill-item"><FaLightbulb /> Problem Solver</div>
            <div className="skill-item"><FaPalette /> Creative Designer</div>
            <div className="skill-item"><FaLaptopCode /> Web Developer</div>
            <div className="skill-item"><FaLaptopCode /> Full Stack</div>
          </div>

          <div className="skills-cta">
            <p>✨Just me — a girl who loves code, design, and bringing ideas to life. Let’s <span onClick={() => setActivePage('contact')}>get in touch!</span> 💌</p>
          </div>
        </div>
      </div>
        ...
        {showMore && (
          <>
            ...
            <div className="more-buttons">
              <button className="hire-me-btn" onClick={() => setActivePage('contact')}>Hire Me 💌</button>
              <button className="see-projects-btn" onClick={() => setActivePage('projects')}>See Projects 🚀</button>
            </div>
          </>
        )}
      </div>
